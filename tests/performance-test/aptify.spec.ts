...
test(`Performance test for memberId`, async ({ page }) => {
  ...
  await page.goto("https://rhapsody-test.aapc.com/Aptify/#/appdashboard/-1");
  await page.getByPlaceholder("Search...").fill("2174270");
  await page.click('span[title="Universal Search"]');
  await page.click('div[class="a-search-results-data a-search-container"]>i');
  await page.getByRole("button", { name: "Create Order" }).click();

  await page.getByPlaceholder("Find Product...").click();
  await page.getByPlaceholder("Find Product...").fill("Individual Membership");
  await page
